...
module.exports.waterlock = {
      ...
      passwordReset:{
        ...
        mail: {
          ...
          options:{
            service: 'Gmail',
            auth: {
              user: 'lissethramirez876@gmail.com',
              pass: '18456233lisseth16375819'
            }
          },
          from: 'no-reply@petbook.com',
          subject: 'Tu contraseña en Petbook ha sido cambiada!',
  ...
  jsonWebTokens:{
    ...
    // CHANGE THIS SECRET
    secret: 'Lisseth1845623318456233',
    expiry:{
      unit: 'days',
      length: '7'
    },
